...
var messages = {
  ...
  messageTimeout: function (message) {
    ...
    setTimeout(function () { messages.hideMessage(message); }, 5000);
  },
  ...
  showNewMessage: function (message) {
    $(".pt-page-7  .messages").append('<div class="message active-message"><div class="bubble"><span>' + message.message + '</span></div><div class="message-username">' + message.username + '</div></div>');
